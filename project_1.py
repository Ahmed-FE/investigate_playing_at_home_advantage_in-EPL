...
def create_data_frame_to_plot_result(table_name,id_column_name,country_team_column_name,country_team_name_list,column_name_in_match_table,list_of_seasons,*argv):
    ...
    *argv :  the first two arguments are the label of your two data. the third argument is 'away_team_api_id' if needed 
...
# this part is working when I need to calculate home and away results for the same team 
        try :
             argv[2]=='away_team_api_id'
             season_result2=season_results_for_a_team_or_country(table_name,id_column_name,country_team_column_name,country_team_name,argv[2],season)
...
# teams=['Manchester United','Liverpool','Chelsea','Arsenal','Everton','Aston Villa','Fulham',
...
teams=['Chelsea','Manchester United','Arsenal',
...
column_name_in_match_table=['home_team_api_id','away_team_api_id','country_id']
#seasons=['2008/2009']
seasons=['2009/2010']
results=create_data_frame_to_plot_result(table_name[0],id_column_name[0],country_team_column_name[0],teams,column_name_in_match_table[0],seasons,'winning_percentage_home','winning_percentage_away','away_team_api_id')
results.plot.bar()
plt.title('winning at home vs winning away  percentage for teams from 1st to 20th in England in 2010 ')
plt.figure
results=create_data_frame_to_plot_result(table_name[0],id_column_name[0],country_team_column_name[0],teams,column_name_in_match_table[0],seasons,'winning_percentage_home','losing_percentage_Home')
results.plot.bar()
plt.title('winning vs lossing percentage for teams from 1st to 20th in England in 2010 ')
# list_of_seasons=['2008/2009','2009/2010','2010/2011','2011/2012','2012/2013','2013/2014','2014/2015','2015/2016']
# countries=['England'] 
# plt.figure
# results=create_data_frame_to_plot_result(table_name[1],id_column_name[1],country_team_column_name[1],countries,column_name_in_match_table[2],list_of_seasons,'winning_percentage_home','losing_percentage_Home')
# results.plot.bar()
# plt.title('winning vs losing percentage for home team in England from 2008/2009 to 2015/2016')
